...
?>
<section data-type='#reports-classroom' id='reports-classroom-masterschedule'>
    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">Master Class Schedule report</p>
        ...
        <div class='row formBase rowspacer'>
            <div class='eleven columns centered insideForm'>
                        ...
                        <dl class='field row'>
                        	<div id="sctypediv" style="display:none">
                                ...
                                <div class="selectbox">
                                    ...
                                    <div class="selectbox-options">
                                    <ul role="options" style="width:100%">
                                        <li><a tabindex="-1" href="#" data-option="1" onClick="$('#viewreportdiv').show();">Dyad Schedule</a></li>
                                        <li><a tabindex="-1" href="#" data-option="2" onClick="$('#viewreportdiv').show();">Triad Schedule</a></li>
                                    </ul>
                                </div>
                                </div> 
                            </div>
                ...
                <input type="hidden" id="hidfilename" name="hidfilename" value="<?php echo "masterschedulereport_"; ?>" />
                
                <!--View Report Button-->
                <div class='row rowspacer' style="display:none" id="viewreportdiv">
                    <input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right;" value="View Report" onClick="fn_showpassreport(3);" />
                </div>
            </div>
        </div>
    </div>
