                                 ...
                                 <tr>
                                   <td> Final Score: &nbsp;</td> <td id='studentscore' class='studentscore'> </td>
                                     ...
                                     <?php
                                        ...
                                        {   ?>
                                             &nbsp;&nbsp;&nbsp;<input class="darkButton" type="button" id="btnstep2" style="float: none; height: 34px; width: 76px;" value="Save" onClick="fn_saverubric('<?php echo $rubid;?>','<?php echo $expeditionid;?>','<?php echo $scheduletype;?>');" />
                                            <?php
                                        }
                                        else
                                        {   ?>
