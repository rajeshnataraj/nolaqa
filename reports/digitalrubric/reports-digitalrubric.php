...
?>
<section data-type='2home' id='reports-digitalrubric'>
	<script language="javascript">
    	$.getScript("reports/digitalrubric/reports-digitalrubric.js");
    </script>

    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
                <p class="dialogTitle">Digital Grading Rubric Report</p>
								 	...
								 	if($sessmasterprfid == 7)//For school Admin 
								   	{
									    $qry = $ObjDB->QueryObject("SELECT w.* FROM ((SELECT b.fld_class_id AS classid, a.fld_class_name AS classname,15 AS exptype
																		...
																		AND a.fld_school_id='".$schoolid."' AND b.fld_flag='1' 
			...
			<!--Shows Student -->
             ...
             <?php } ?>
               ...
               <!--Shows Class/Student dropdown-->
                 ...
                 <input type="hidden" id="hidfilename" name="hidfilename" value="<?php echo "digitalrubric_"; ?>" />
