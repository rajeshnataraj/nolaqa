                   ...
                   <div class="selectbox-options">
                       ...
                       <ul role="options" style="width:100%">
                        ...
                        $qry = $ObjDB->QueryObject("SELECT w.* FROM (
                                                ...
                                                UNION ALL
                                                (SELECT a.fld_id AS schid, a.fld_schedule_name AS schedulename,17 AS exptype, a.fld_id AS assingnmentid
                                                FROM itc_class_rotation_expschedule_mastertemp AS a
                                                LEFT JOIN itc_class_master AS b ON b.fld_id=a.fld_class_id
                                                WHERE a.fld_class_id='".$clsid."' AND  a.fld_delstatus='0' AND a.fld_flag='1' 
                                                AND b.fld_delstatus = '0'  AND b.fld_flag = '1')
                                                UNION ALL
                                                (SELECT a.fld_id AS schid,a.fld_schedule_name AS schedulename, 20 AS exptype,a.fld_id AS assingnmentid
...
if($oper=="showexpedition" and $oper != " " )
{
        ...
        else
        {
                $qry = $ObjDB->QueryObject("SELECT a.fld_expedition_id AS expid, b.fld_exp_name AS expname FROM itc_class_rotation_expschedulegriddet AS a
                                                    ...
                                                    AND b.fld_flag='1'  group by expid ORDER BY expname"); // AND a.fld_createdby='".$uid."' 
        }
      ...
      <div class='six columns'>
        ...
        if($scheduletype=='15')
        {
                $qrystudent= $ObjDB->QueryObject("SELECT b.fld_student_id AS studentid,c.fld_fname AS firstname,c.fld_lname AS lastname ,c.fld_username as username, CONCAT(c.fld_fname,' ',c.fld_lname) AS sname FROM itc_class_indasexpedition_master AS a
                                          ...
                                          WHERE a.fld_class_id='".$classid."' AND b.fld_schedule_id='".$scheduleid."' AND a.fld_exp_id='".$expid."'  AND a.fld_flag='1' AND a.fld_delstatus='0' AND b.fld_flag='1' 
        ...
        {
            $qrystudent= $ObjDB->QueryObject("SELECT b.fld_student_id AS studentid,c.fld_fname AS firstname,c.fld_lname AS lastname ,c.fld_username as username, CONCAT(c.fld_fname,' ',c.fld_lname) AS sname FROM itc_class_rotation_modexpschedulegriddet AS a
        ...
        {
            $qrystudent= $ObjDB->QueryObject("SELECT b.fld_student_id AS studentid,c.fld_fname AS firstname,c.fld_lname AS lastname ,c.fld_username as username, CONCAT(c.fld_fname,' ',c.fld_lname) AS sname FROM itc_class_rotation_expschedulegriddet AS a
