...
?>
<section data-type='2home' id='reports-classstandards'>
	<script language="javascript">
    	$.getScript("reports/classstandards/reports-classstandards.js");
    </script>

    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
                <p class="dialogTitle">Class Standards Progress Report</p>
            ...
            <div class='eleven columns centered insideForm'> 
                ...
                <div class="row rowspacer">
                    <div class='six columns'> 
                     ...
                     <div class='six columns'> 
                        <!--Shows Class Dropdown-->
                        <div id="doc1div" style="display:none">
                ...
                <input type="hidden" id="hidfilename" name="hidfilename" value="<?php echo "classstdprogressreport_"; ?>" />
                
                <!--View Report Button-->
                <div class='row rowspacer' style="display:none" id="viewreportdiv">
                    <input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right;" value="View Report" onClick="fn_classstdprogress();" />
                </div>
            </div>
        </div>
    </div>
