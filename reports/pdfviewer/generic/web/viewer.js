...
//var DEFAULT_URL = parent.document.getElementById('hidpdfile').value; //$('#hidpdfile', window.parent.document).val();
  ...
  download: function pdfViewDownload() {
   ...
   /* var url = this.url.split('#')[0];
    url += '#pdfjs.action=download';*/
	 //alert(url);
	var lik=DEFAULT_URL.replace('../../../../reports/pdf/','');
	
   // window.open("../../../../"+url, '_self');
   window.open('download.php?filename='+lik, '_self');
