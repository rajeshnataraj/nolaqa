...
if($id[0]==7)
{
    ...
    $schname = $ObjDB->SelectSingleValue("SELECT fld_schedule_name FROM itc_class_rotation_expschedule_mastertemp WHERE fld_id='".$scheduleid."'");

    $qryexpsch=$ObjDB->QueryObject("SELECT fld_exp_id as expid,fld_numberofrotation as numberofrotations FROM itc_class_rotation_expmoduledet 
        ...
        while($rowexpsch = $qryexpsch->fetch_assoc()) // show the module based on number of copies
        {
            ...
            for($r=0;$r<sizeof($list10);$r++)
            {
                ...
                $qrystudents = $ObjDB->QueryObject("SELECT CONCAT(a.fld_fname,' ',a.fld_lname) AS studentname, a.fld_id AS studentid 
                                                    ...
                                                    AND b.fld_schedule_id='".$scheduleid."' AND b.fld_expedition_id='".$expid."' AND fld_rotation='".$rotation."' AND b.fld_flag='1' 
                ...
                { 
                    ...
                    $qry = $ObjDB->QueryObject("SELECT a.fld_rubric_id AS rubricids, fn_shortname(CONCAT(a.fld_rubric_name,' / Rubric'),1) AS rubnam, 
                                                        ...
                                                        LEFT JOIN itc_class_rotation_expschedule_mastertemp AS d ON a.fld_schedule_id=d.fld_id 
                                                                ...
                                                                AND d.fld_delstatus='0'  AND a.fld_schedule_type='17'
                                                ...
                                                UNION ALL
                                                    ...
                                                    WHERE a.fld_class_id='".$classid."' AND a.fld_sch_id='".$scheduleid."' AND a.fld_texpid='".$expid."' AND a.fld_schtype_id='19' AND a.fld_pretest NOT IN(0)
                                                ...
                                                UNION ALL
                                                    ...
                                                    WHERE a.fld_class_id='".$classid."' AND a.fld_sch_id='".$scheduleid."' AND a.fld_texpid='".$expid."' AND a.fld_schtype_id='19' AND a.fld_posttest NOT IN(0)
                                               ");
                    if($qry->num_rows>0)
                    {
                        ...
                        for($i=0;$i<sizeof($rubricname);$i++)
                        {
                            ...
                            else if($typeids[$i]=='2') //Pre Test
                            {
                                ...
                                $qrycorrectcount = $ObjDB->QueryObject("SELECT a.fld_correct_answer AS crctcount  FROM itc_test_student_answer_track AS a
                                                                        ...
                                                                        WHERE b.fld_expt = '".$expid."' AND a.fld_student_id = '".$studentid."' AND a.fld_schedule_id='".$scheduleid."'  AND a.fld_schedule_type='19'
                                ...
                                if($qrycorrectcount->num_rows>0)
                                {
                                 ...
                                 /*****Teacher Points earned code start here for pre/post test*****/
                                    $tpointsearned = $ObjDB->SelectSingleValue("SELECT fld_teacher_points_earned FROM itc_exp_points_master 
                                                                                WHERE fld_schedule_type='19' AND fld_student_id='".$studentid."' 
                                ...
                                {
                                    $out .= $pointsearnedfortest." / ".$possiblepointfortest1.",";
