...
?>
<section data-type='#reports-expedition' id='reports-gradereports-classexpedition'>
    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">Class Expedition Report</p>
        ...
        <div class='row formBase rowspacer'>
            <div class='eleven columns centered insideForm'>
                                ...
                                <ul role="options" style="width:100%">
                                    ...
                                    if($qry->num_rows>0){
                                        while($row = $qry->fetch_assoc())
                                        {
                                            extract($row);
                                            ?>
                                            <li><a tabindex="-1" href="#" data-option="<?php echo $schoolid;?>" onclick="fn_showteachers(<?php echo $schoolid;?>,0,7)"><?php echo $schoolname; ?></a></li>
                                            <?php
                                        }
                                    }?>      
                                </ul>
                                       ...
                                       /*Mohan M updated  */
                                        ...
                                        if($qry->num_rows>0){
                                            while($row = $qry->fetch_assoc())
                                            {
                                                extract($row);
                                                ?>
                                                <li><a tabindex="-1" href="#" data-option="<?php echo $classid;?>" onClick="fn_hide(); fn_load_schedule(7,<?php echo $classid; ?>)"><?php echo $classname; ?></a></li>
                                                <?php
                                            }
                                        }?>      
                                    </ul>
                ...
                <div class='row rowspacer'>
                    ...
                    <div class='twelve columns'>
                        <dl class='field row' id='rotationdiv' style="display:none;">  
                ...
                <input type="hidden" id="hidrepname" name="hidrepname" value="<?php echo "classexpeditionreport_"; ?>" />
                <input type="hidden" id="hidexpschname" name="hidexpschname" value="<?php echo "classexprescheduleport_"; ?>" />
                
                 <input type="hidden" id="expschedule" name="expschedule" value="<?php echo "15"; ?>" />
                 <input type="hidden" id="schoolid" name="schoolid" value="<?php echo $schoolid; ?>" />
                 <input type="hidden" id="sendistid" name="sendistid" value="<?php echo $sendistid; ?>" />
                
                <!--View Report Button-->
                <div class='row rowspacer' style="display:none" id="viewreportdiv">
                    <input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right; margin-left:5px" value="Export as csv" onClick="fn_export(7);" />
                    <input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right;" value="View Report" onClick="fn_gradereport(7);" />
                </div>
            </div>
        </div>
    </div>
