...
?>
<section data-type='#reports-gradereports' id='reports-gradereports-classschedule'>
    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">Class Schedule Scores report</p>
        ...
        <div class='row formBase rowspacer'>
            <div class='eleven columns centered insideForm'>
                                    ...
                                    <ul role="options" style="width:100%">
                                        ...
                                        if($qry->num_rows>0){
                                            while($row = $qry->fetch_assoc())
                                            {
                                                extract($row);
                                                ?>
                                                <li><a tabindex="-1" href="#" data-option="<?php echo $classid;?>" onclick="$('#unid').hide(); $('#cuid').hide(); fn_load_schedule(1,<?php echo $classid;?>);"><?php echo $classname; ?></a></li>
                                                <?php
                                            }
                                        }?>      
                                    </ul>
                ...
                <input type="hidden" id="hidclsschname" name="hidclsschname" value="<?php echo "classschedulereport_"; ?>" />
                
                <!--View Report Button-->
                <div class="row rowspacer" style="display:none" id="viewreportdiv">
                	<input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right; margin-left:5px" value="Export as csv" onClick="fn_export(1);" />
                    <input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right;" value="View Report" onClick="fn_gradereport(1);" />
                </div>
            </div>
        </div>
    </div>
