...
function fn_showdetails(dsid,rowid)
{
   $.fancybox.showActivity();
    $.ajax({
        type	: "POST",
        cache	: false,
        url     : "reports/fastesttimeoverall/reports-fastesttimeoverall-ajax.php",
...
function fastesttimeoverall_view()
{
   ...
   if(tracklenvalue==""){
       ...
       var val= tracklenvalue;      
        ...
        fn_cancel('reports-fastesttimeoverall');
     	setTimeout('showpageswithpostmethod("reports-fastesttimeoverall-preview","reports/fastesttimeoverall/reports-fastesttimeoverall-preview.php","id='+ val+'");',500);
...
{	
        var tracklenvalue=$('#tracklen').val();
    	setTimeout('removesections("#reports-fastesttimeoverall-preview");',500);      
