...
?>
	<script language="javascript" type="text/javascript">
		...
		$('#cviewreport').addClass("active-last").parent().removeClass("dim");
                ...
                $html = file_get_contents(REPORT_SERVER_URL.'/index.php?id='.$id.'&oper='.$oper.'&filename='.$filename.'&hostname='.$_SERVER['SERVER_NAME'].'&uid='.$uid.'&sessmasterprfid='.$sessmasterprfid.'&sessionid='.$sessionid.'');
