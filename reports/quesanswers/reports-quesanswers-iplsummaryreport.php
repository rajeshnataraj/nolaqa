...
?>
<section data-type='#reports-quesanswers' id='reports-quesanswers-iplsummaryreport'>
    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">IPL Progress Summary report</p>
        ...
        <div class='row formBase rowspacer'>
            <div class='eleven columns centered insideForm'>
                                    ...
                                    <ul role="options" style="width:100%">
                                        ...
                                        if($qry->num_rows>0){
                                            while($row = $qry->fetch_assoc())
                                            {
                                                extract($row);
                                                ?>
                                                <li><a tabindex="-1" href="#" data-option="<?php echo $classid;?>" onclick="$('#schedulediv').show(); fn_load_schedules(<?php echo $classid;?>);"><?php echo $classname; ?></a></li>
                                                <?php
                                            }
                                        }?>      
                                    </ul>
                ...
                <div class="row rowspacer" id="stupassdiv" style="display:none">
                    <div class='six columns'>
                        <form id="frmrep" name="frmrep">
                            <div class="field">
                                <label class="checkbox" for="iplvistied" onclick="fn_check()">
                                    <input name="iplvistied" id="iplvistied" value="1" type="checkbox" style="display:none;"/>
                                    <span></span>	Show Not Visited Ipls
                                </label>
                            </div>
                        </form>
                ...
                <input type="hidden" id="hidiplsumaname" name="hidiplsumaname" value="<?php echo "iplsummaryreport_"; ?>" />
                ...
                <div class='row rowspacer' style="display:none" id="viewreportdiv">
                    <input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right;" value="View Report" onClick="fn_questionreport(3);" />
                </div>
            </div>
        </div>
    </div>
