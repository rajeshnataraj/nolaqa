...
?>
<section data-type='#reports-quesanswers' id='reports-quesanswers-iplanalyticsreport'>
    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">IPL Analytics report</p>
        ...
        <div class='row formBase rowspacer'>
            <div class='eleven columns centered insideForm'>
                ...
                <input type="hidden" id="hidiplananame" name="hidiplananame" value="<?php echo "iplanalyticsreport_"; ?>" />
                ...
                <div class='row rowspacer' style="display:none" id="viewreportdiv">
                    <input class="darkButton" type="button" id="btnstep" style="width:200px; height:42px; float:right;" value="View Report" onClick="fn_questionreport(2);" />
                </div>
            </div>
        </div>
    </div>
