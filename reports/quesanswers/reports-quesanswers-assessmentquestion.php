...
?>
<section data-type='#reports-quesanswers' id='reports-quesanswers-assessmentquestion'>
    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">Individual Assessment Question report</p>
        ...
        <div class='row formBase rowspacer'>
            <div class='eleven columns centered insideForm'>
                                    ...
                                    <ul role="options" style="width:100%">
                                        ...
                                        if($qry->num_rows>0){
                                            while($row = $qry->fetch_assoc())
                                            {
                                                extract($row);
                                                ?>
                                                <li><a tabindex="-1" href="#" data-option="<?php echo $classid;?>" onclick="$('#assignmentdiv').show(); fn_load_assignments(3,<?php echo $classid;?>);"><?php echo $classname; ?></a></li>
                                                <?php
                                            }
                                        }?>      
                                    </ul>
                ...
                <input type="hidden" id="hidtestname" name="hidtestname" value="<?php echo "assessmentquestion_"; ?>" />
                
                <!--View Report Button-->
                <div class='row rowspacer' style="display:none" id="viewreportdiv">
                    <input type="button" id="btnstep" class="darkButton" style="width:200px; height:42px; float:right;" value="View Report" onClick="fn_questionreport(5);" />
                </div>
            </div>
        </div>
    </div>
