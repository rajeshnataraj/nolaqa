...
$html = file_get_contents(__HOSTADDR__.'reports/pdf-genrate-code/iplanalyticsreport-output.php?id='.$id.'');
...
class MYPDF extends TCPDF {
	...
	public function Header() { // Page header
		...
		$alen = strlen ('Assignment Name : '.$assname);
		if($alen>40)
			$alength = 100;
		else
			$alength = 120;
		$this->Text($alength, 50, 'Assignment Name : '.$assname);
	}
