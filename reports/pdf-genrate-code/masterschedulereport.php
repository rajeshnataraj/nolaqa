...
$html = file_get_contents(__HOSTADDR__.'reports/pdf-genrate-code/masterschedulereport-output.php?id='.$id.'');
...
class MYPDF extends TCPDF {
	...
	public function Header() { // Page header
		...
		$this->Text(10, 18, 'Master Schedule Report');
...
$pdf->SetTitle("Master Schedule Report");
