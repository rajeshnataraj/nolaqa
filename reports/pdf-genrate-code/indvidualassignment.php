...
$html = file_get_contents(__HOSTADDR__.'reports/pdf-genrate-code/indvidualassignment-output.php?id='.$id.'');
...
class MYPDF extends TCPDF {
	public function Header() { // Page header
		...
		$this->Text(10, 18, 'Individual Assignment');
		...
		if($ids[6]==1) {
			$name = $ObjDB->SelectSingleValue("SELECT CONCAT(fld_fname,' ',fld_lname) 
...
$pdf->SetTitle('Individual Assignment');
