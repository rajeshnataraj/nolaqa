...
$destuniqueid = $ObjDB->SelectSingleValue("SELECT fld_destunique_id FROM itc_exp_destination_master WHERE fld_id='".$destinationid."' AND fld_delstatus='0' AND fld_flag='1'");

$cnt = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_dest_play_track WHERE fld_dest_id='".$destinationid."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
...
if($cnt===0)
{
	$ObjDB->NonQuery("INSERT INTO itc_exp_dest_play_track(fld_exp_id, fld_dest_id, fld_student_id, fld_schedule_id, fld_schedule_type, fld_read_status, fld_created_by, fld_created_date, fld_dest_unique_id) 
								VALUES('".$expid."', '".$destinationid."', '".$uid."', '".$schid."', '".$schtype."', '0', '".$uid."', '".$date."', '".$destuniqueid."')");
}

if($uid1!='' and $uid1!=0)
{
	$cnt1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_dest_play_track WHERE fld_dest_id='".$destinationid."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");

	if($cnt1===0)
	{
		$ObjDB->NonQuery("INSERT INTO itc_exp_dest_play_track(fld_exp_id, fld_dest_id, fld_student_id, fld_schedule_id, fld_schedule_type, fld_read_status, fld_created_by, fld_created_date, fld_dest_unique_id) 
									VALUES('".$expid."', '".$destinationid."', '".$uid1."', '".$schid."', '".$schtype."', '0', '".$uid1."', '".$date."', '".$destuniqueid."')");
	}
}
...
?>
<section data-type='2home' id='assignment-expedition-tasks'>
    <div class='span12 dialogStyle1'>
        <div class='row' style="margin-bottom:15px;">
            <div class='twelve columns'>
            	<span id="changeclass" style="font-family: 'source_sans_proregular'; font-size: 18px; font-weight: bold;">Destination <?php echo $destinationorder;?>:</span>
        ...
        <div class='row-fluid'>
            ...
            <div class='row buttons' id="tasklist">
                <p id="changeclass" style="font-family: 'source_sans_proregular'; font-size: 18px; font-weight: bold; margin-bottom:7px;">Tasks:</p>
                ...
                if($qrytasks->num_rows>0) {
					...
					$statusflag = true;
                        ...
                        while($rowqrytasks = $qrytasks->fetch_object()){
                            $tstatus = $ObjDB->SelectSingleValueInt("SELECT fld_status FROM itc_exp_res_status WHERE fld_exp_id='".$expid."' AND fld_task_id='".$rowqrytasks->fld_id."' AND fld_school_id='".$schoolid."' AND fld_created_by='".$shlteacherid."' AND fld_user_id='".$indid."'");
                            ...
                            if($tstatus=='' or $tstatus=='0' or $tstatus==NULL)
                            {
                                ...
                                $tstatus = $ObjDB->SelectSingleValue("SELECT fld_status FROM itc_exp_res_status WHERE fld_exp_id='".$expid."' AND fld_task_id='".$rowqrytasks->fld_id."' AND fld_created_by IN (".$createdids.") AND fld_flag='1'");
                            ...
                            if($tstatus !=3){
                                ...
                                if($qrystutaskpre->num_rows>0){
                                    ...
                                    if($pretesttaskstatus !=3){
                                        ...
                                        $tasktestcntpre = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_testplay_track WHERE fld_dest_id='".$destinationid."' AND fld_task_id='".$rowqrytasks->fld_id."' AND fld_task_test_id='".$pretestid."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                        if($tasktestcntpre == '1'){
                                            $taskteststatus=1;
                                        ...
                                        // Block first test
                                        if($cntt1 !=1){
                                            $taskcntpre = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$beforetaskid."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                       ...
                                       ?>
                                        <a class="<?php echo $newclass1; ?>" onclick="fn_tasktest(<?php echo $pretestid;?>,<?php echo $pretesttaskstatus;?>,<?php echo $rowqrytasks->fld_id;?>,<?php echo $destinationid;?>,<?php echo $expid;?>,<?php echo $schid;?>,<?php echo $destinationorder?>,<?php echo $schtype;?>);">
						...
						$cnt = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$rowqrytasks->fld_id."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                            if($uid1!='' and $uid1!=0)
                            {
                                $cnt1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$rowqrytasks->fld_id."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                            }
                            /* Required tasks */					
                            if($tstatus==1)
                            {
                            ...
                            {
                                $cnt = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$rowqrytasks->fld_id."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
								...
								VALUES('".$expid."', '".$destinationid."', '".$rowqrytasks->fld_id."', '".$uid."', '".$schid."', '".$schtype."', '1', '".$uid."', '".$date."', '".$rowqrytasks->taskuni."')");
                                }   
                                if($uid1!='' and $uid1!=0)
                                {
                                    $cnt1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$rowqrytasks->fld_id."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                                    if($cnt1===0)
                                    {
                                        $ObjDB->NonQuery("INSERT INTO itc_exp_task_play_track(fld_exp_id, fld_dest_id, fld_task_id, fld_student_id, fld_schedule_id, fld_schedule_type, fld_read_status, fld_created_by, fld_created_date, fld_task_unique_id) 
								VALUES('".$expid."', '".$destinationid."', '".$rowqrytasks->fld_id."', '".$uid1."', '".$schid."', '".$schtype."', '1', '".$uid1."', '".$date."', '".$rowqrytasks->taskuni."')");
                                    }
                                }
                            ...
                            if($dimflag == 1){
                                $checkcom = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$rowqrytasks->fld_id."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                if($uid1 != '' and $uid1!=0) {
                                    $checkcom1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$rowqrytasks->fld_id."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                                }
                                if($uid1 != '' and $uid1!=0) {
                            ...
                            if($passporttask =="passport"){
                                $i=0;
                                $dataparam =  $destinationid.','.$rowqrytasks->fld_id.','.$i.','.$expid.','.$schid.','.$schtype.",".$passporttask.",".$passportmediaurltask;
                            }
                            else{
                            $dataparam =  $destinationid.','.$rowqrytasks->fld_id.','.$i.','.$expid.','.$schid.','.$schtype;
                            }
                            
                            if($tstatus!=3)
                            {
						?>
						<a class="<?php echo $newclass; ?>" href="#assignment-expedition-resourses" id="btnassignment-expedition-resourses" name="<?php echo $dataparam; ?>">
                               ...
                               $stutaskpostcount1 = $qrystutaskpost->num_rows;
                                if($qrystutaskpost->num_rows>0){
                                    ...
                                    if($postteststatus !=3){
                                        ...
                                        $tasktestcntpost = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_testplay_track WHERE fld_dest_id='".$destinationid."' AND fld_task_id='".$rowqrytasks->fld_id."' AND fld_schedule_id='".$schid."' AND fld_task_test_id='".$posttestid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                        ...
                                        ?>
                                            <a class="<?php echo $newclass2; ?>" onclick="fn_tasktest(<?php echo $posttestid;?>,<?php echo $postteststatus;?>,<?php echo $rowqrytasks->fld_id;?>,<?php echo $destinationid;?>,<?php echo $expid;?>,<?php echo $schid;?>,<?php echo $destinationorder?>,<?php echo $schtype;?>);">
                                                <div class="icon-Destination"></div>
                    ...
                    if($show == 0)
                    {
                         $tasklastid = $ObjDB->SelectSingleValue("SELECT a.fld_id 
                            ...
                            if($taskposttest !=""){
                                $tasktestcntpost = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_testplay_track WHERE fld_dest_id='".$destinationid."' AND fld_task_id='".$tasklastid."' AND fld_task_test_id='".$taskposttest."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
    ...
    <script>
		if($('#assignment-expedition-tasks').prevAll('section:eq(1)').attr('class')=='blueWindow1')
		{
