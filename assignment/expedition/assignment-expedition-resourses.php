...
$taskuniqueid = $ObjDB->SelectSingleValue("SELECT fld_task_id FROM itc_exp_task_master WHERE fld_id='".$taskid."' AND fld_delstatus='0' AND fld_flag='1'");

$cnt = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$taskid."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
...
if($cnt===0)
{
	$ObjDB->NonQuery("INSERT INTO itc_exp_task_play_track(fld_exp_id, fld_dest_id, fld_task_id, fld_student_id, fld_schedule_id, fld_schedule_type, fld_read_status, fld_created_by, fld_created_date, fld_task_unique_id) 
						VALUES('".$expid."', '".$destinationid."', '".$taskid."', '".$uid."', '".$schid."', '".$schtype."', '0', '".$uid."', '".$date."', '".$taskuniqueid."')");
}

if($uid1!='' and $uid1!=0)
{
	$cnt1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_id='".$taskid."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");

	if($cnt1===0)
	{
		$ObjDB->NonQuery("INSERT INTO itc_exp_task_play_track(fld_exp_id, fld_dest_id, fld_task_id, fld_student_id, fld_schedule_id, fld_schedule_type, fld_read_status, fld_created_by, fld_created_date, fld_task_unique_id) 
							VALUES('".$expid."', '".$destinationid."', '".$taskid."', '".$uid1."', '".$schid."', '".$schtype."', '0', '".$uid1."', '".$date."', '".$taskuniqueid."')");
	}
}
...
?>
<section data-type='2home' id='assignment-expedition-resourses'>
    <div class='span12 dialogStyle1'>
        <div class='row'>
            <div class='twelve columns'>
            	<span id="changeclass" style="font-family: 'source_sans_proregular'; font-size: 18px; font-weight: bold;">Task <?php echo $taskorder;?>:</span>
        ...
        <div class='row-fluid'>
            ...
            <div class='row buttons' id="reslist">
                <p id="changeclass" style="font-family: 'source_sans_proregular'; font-size: 18px; font-weight: bold; margin-bottom:7px;">Resources:</p>
                <input type="hidden" id="callresdiv" name="callresdiv" value="<?php echo $ids; ?>" />
                <?php 
                $qryresources= $ObjDB->QueryObject("SELECT fld_id, fld_res_id AS resuniqid, fld_res_name, fn_shortname (CONCAT(fld_res_name), 1) AS shortname, fld_res_file_name, fld_res_file_type, fld_typeof_res, fld_res_status, fld_order, fld_next_order, fld_resource_status FROM itc_exp_resource_master WHERE fld_task_id='".$taskid."' AND fld_flag='1' AND fld_delstatus='0' ORDER BY fld_order");
                ...
                if($qryresources->num_rows>0) {
                            ...
                            while($rowqqryresources = $qryresources->fetch_object()){
                                ...
                                $rstatus = $ObjDB->SelectSingleValueInt("SELECT fld_status FROM itc_exp_res_status WHERE fld_exp_id='".$expid."' AND fld_res_id='".$rowqqryresources->fld_id."' AND fld_school_id='".$schoolid."' AND fld_created_by='".$shlteacherid."' AND fld_user_id='".$indid."'");
                                ...
                                if($rstatus=='' or $rstatus=='0' or $rstatus==NULL)
                                {
                                    ...
                                    $rstatus = $ObjDB->SelectSingleValue("SELECT fld_status FROM itc_exp_res_status WHERE fld_exp_id='".$expid."' AND fld_res_id='".$rowqqryresources->fld_id."' AND fld_created_by IN (".$createdids.") AND fld_flag='1'");
                                ...
                                if($rstatus !=3){
                                    ...
                                    $qrysturespre = $ObjDB->QueryObject("select a.fld_id AS pretestid, a.fld_test_name AS pretestname,fn_shortname (CONCAT(a.fld_test_name), 1) AS shortname1,b.fld_status as pretestresstatus,(CASE b.fld_status WHEN 1 THEN 'required' WHEN 2 THEN 'notrequired' WHEN 3 THEN '' END) AS badgestatuspre  from itc_test_master as a
                                                                            ...
                                                                            where a.fld_destid ='".$destinationid."' and a.fld_prepostid ='1' and b.fld_tprepost ='1' and b.fld_flag=1 and b.fld_texpid='".$expid."'
                                    ...
                                    if($qrysturespre->num_rows>0){
                                        ...
                                        if($pretestresstatus !=3){
                                            ...
                                            $restestcntpre = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_testplay_track WHERE fld_dest_id='".$destinationid."' AND fld_task_id='".$taskid."' AND fld_res_id='".$rowqqryresources->fld_id."' AND fld_res_test_id='".$pretestid."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                            if($restestcntpre == '1'){
                                                $resteststatus=1;
                                            ...
                                            // Block first test
                                            if($cntr1 !=1){
                                                $rescntpre = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_play_track WHERE fld_res_id='".$beforeresid."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                           ...
                                           ?>
                                                <a class="<?php echo $newclass1; ?>" onclick="fn_restest(<?php echo $pretestid;?>,<?php echo $pretestresstatus;?>,<?php echo $rowqqryresources->fld_id;?>,<?php echo $taskid;?>,<?php echo $destinationid;?>,<?php echo $expid;?>,<?php echo $schid;?>,<?php echo $taskorder;?>,<?php echo $schtype;?>);">
                                ...
                                $resids = $ObjDB->SelectSingleValue("SELECT GROUP_CONCAT(fld_id) FROM itc_exp_resource_master WHERE fld_res_id=(SELECT fld_res_id FROM itc_exp_resource_master WHERE fld_id='".$rowqqryresources->fld_id."')");

                                $cnt = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_play_track WHERE fld_res_id IN (".$resids.")  AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                if($uid1!='' and $uid1!=0){
                                    $cnt1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_play_track WHERE fld_res_id IN (".$resids.")  AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                                }
                                ...
                                {                                   
                                    ...
                                    if($dimflagr == 1){
                                        $checkcom = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_play_track WHERE fld_res_id='".$rowqqryresources->fld_id."'  AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");

                                        if($uid1!='' and $uid1!=0){
                                            $checkcom1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_play_track WHERE fld_res_id='".$rowqqryresources->fld_id."'  AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                                        }
                                        if($uid1!='' and $uid1!=0){
                                ...
                                {
                                    $cnt = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_play_track WHERE fld_res_id='".$rowqqryresources->fld_id."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                    ...
                                    if($cnt===0)
                                    {
                                            $ObjDB->NonQuery("INSERT INTO itc_exp_res_play_track(fld_exp_id, fld_dest_id, fld_task_id, fld_res_id, fld_student_id, fld_schedule_id, fld_schedule_type, fld_read_status, fld_created_by, fld_created_date, fld_res_unique_id) 
                                                                    VALUES('".$expid."', '".$destinationid."', '".$taskid."', '".$rowqqryresources->fld_id."', '".$uid."', '".$schid."', '".$schtype."', '1', '".$uid."', '".$date."', '".$rowqqryresources->resuniqid."')");
                                    }                                
                                    if($uid1!='' and $uid1!=0){
                                        $cnt1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_play_track WHERE fld_res_id='".$rowqqryresources->fld_id."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                                        if($cnt1===0)
                                        {
                                            $ObjDB->NonQuery("INSERT INTO itc_exp_res_play_track(fld_exp_id, fld_dest_id, fld_task_id, fld_res_id, fld_student_id, fld_schedule_id, fld_schedule_type, fld_read_status, fld_created_by, fld_created_date, fld_res_unique_id) 
                                                                    VALUES('".$expid."', '".$destinationid."', '".$taskid."', '".$rowqqryresources->fld_id."', '".$uid1."', '".$schid."', '".$schtype."', '1', '".$uid1."', '".$date."', '".$rowqqryresources->resuniqid."')");
                                        }
                                    }
                                ...
                                if($rowqqryresources->fld_res_file_type != 6 and $rowqqryresources->fld_res_file_type != 7){
                                        $flag=$ObjDB->SelectSingleValueInt("SELECT fld_lock FROM itc_class_indasexpedition_master WHERE fld_id='".$schid."'");
                                        if($passport == "passport"){
                                            
                                            $resclick = "loadiframespassport('path?destinationid=".$destinationid."&taskid=".$taskid."&resourceid=".$rowqqryresources->fld_id."&type=".$rowqqryresources->fld_res_file_type."&filename=".$rowqqryresources->fld_res_file_name."','preview',$expid,'$passportmediaurl');";
                                        }
                                        else{
							...
							$statusflag = true;
                                ...
                                // Post test starts
                                    $qrysturespost = $ObjDB->QueryObject("select a.fld_id AS posttestid, a.fld_test_name AS posttestname,fn_shortname (CONCAT(a.fld_test_name), 1) AS shortname2,b.fld_status AS postteststatus,(CASE b.fld_status WHEN 1 THEN 'required' WHEN 2 THEN 'notrequired' WHEN 3 THEN '' END) AS badgestatuspost  from itc_test_master as a
                                                                                left join itc_exptest_toogle as b on a.fld_id = b.fld_exptestid 
                                                                                where a.fld_destid ='".$destinationid."' and a.fld_prepostid ='2' and b.fld_tprepost ='2' and b.fld_flag=1 and b.fld_texpid='".$expid."'
                                                                                and b.fld_ttaskid='".$taskid."' and b.fld_tresid='".$rowqqryresources->fld_id."' and b.fld_tdestid='".$destinationid."' and b.fld_created_by='".$shlteacherid."' and b.fld_status IN(1,2) and a.fld_delstatus ='0'");
                                   $sturespostcount1 = $qrysturespost->num_rows;
                                    if($qrysturespost->num_rows>0){
                                        ...
                                        if($postteststatus !=3){
                                            ...
                                            $restestcntpost = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_testplay_track WHERE fld_dest_id='".$destinationid."' AND fld_task_id='".$taskid."' AND fld_res_id='".$rowqqryresources->fld_id."' AND fld_res_test_id='".$posttestid."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                            ...
                                            ?>
                                                ...
                                                <a class="<?php echo $newclass2; ?>" onclick="fn_restest(<?php echo $posttestid;?>,<?php echo $postteststatus;?>,<?php echo $rowqqryresources->fld_id;?>,<?php echo $taskid;?>,<?php echo $destinationid;?>,<?php echo $expid;?>,<?php echo $schid;?>,<?php echo $taskorder;?>,<?php echo $schtype;?>);">
                                                    <div class="icon-Destination"></div>
                        ...
                        if($show == 0)
                        {
                            ...
                            if($latsrespostid !=""){
                                $restestcntpost1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_res_testplay_track WHERE fld_dest_id='".$destinationid."' AND fld_task_id='".$taskid."' AND fld_res_id='".$latsresid."' AND fld_res_test_id='".$latsrespostid."' AND fld_schedule_id='".$schid."' AND fld_read_status='1' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                            ...
                            if($uid1 != '' and $uid1!=0) {
                                $ObjDB->NonQuery("UPDATE itc_exp_task_play_track SET fld_read_status='1', fld_updated_by='".$uid1."', fld_updated_date='".$date."' WHERE fld_task_id='".$taskid."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                            }
                            ?>
                            <script>
                            ...
                            $grouptaskids = $ObjDB->SelectSingleValue("SELECT GROUP_CONCAT(".$fieldtask.") FROM itc_exp_task_master WHERE fld_dest_id='".$destinationid."' AND fld_delstatus='0' AND fld_flag='1'");

                            $taskreadcnt = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_unique_id IN (".$grouptaskids.") AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid."' AND fld_read_status='1'");
                            if($uid1 != '' and $uid1!=0) {
                                $taskreadcnt1 = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_exp_task_play_track WHERE fld_task_unique_id IN (".$grouptaskids.") AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid1."' AND fld_read_status='1'");
                            }
                            if($uid1 != '' and $uid1!=0){
                                 if($taskreadcnt === sizeof(explode(',',$grouptaskids)) && $taskreadcnt1 === sizeof(explode(',',$grouptaskids)))
                                {
                                    $ObjDB->NonQuery("UPDATE itc_exp_dest_play_track SET fld_read_status='1', fld_updated_by='".$uid."', fld_updated_date='".$date."' WHERE fld_dest_id='".$destinationid."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid."'");
                                    $ObjDB->NonQuery("UPDATE itc_exp_dest_play_track SET fld_read_status='1', fld_updated_by='".$uid1."', fld_updated_date='".$date."' WHERE fld_dest_id='".$destinationid."' AND fld_schedule_id='".$schid."' AND fld_delstatus='0' AND fld_student_id='".$uid1."'");
                              ?>
                                    <script>
...
INNER JOIN itc_class_indasexpedition_extcontent_mapping AS LK ON AB.fld_extend_id=LK.fld_ext_id
WHERE AB.fld_task='".$taskid."' AND AB.fld_expedition='".$expid."'AND LK.fld_schedule_id='".$schid."' AND LK.fld_exp_id = '".$expid."' AND AB.fld_delstatus='0'");
                        
                        
                        if($select_viewexpmatlist->num_rows > 0)   {
                                        
                                        ?>
                                        <a class="skip btn mainBtn" href="#assignment-expedition-viewmaterialfortask" id="btnassignment-expedition-viewmaterialfortask" name="<?php echo $expid;?>,<?php echo $destinationid;?>,<?php echo $taskid; ?>,<?php echo $schid; ?>">
    ...
    <script>
		if($('#assignment-expedition-resourses').prevAll('section:eq(1)').attr('class')=='blueWindow1')
		{
