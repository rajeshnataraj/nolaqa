...
{		
	...
	{
		$ObjDB->NonQuery("UPDATE itc_sim_category
	...
	{
		$maxid =$ObjDB->NonQueryWithMaxValue("INSERT INTO itc_sim_category(fld_category_name, fld_created_by, fld_created_date) VALUES ('".$catname."','".$uid."','".$date."')");
	}
...
if($oper=="deletecategory" and $oper != " " )
{
	try
	{
		...
		$count = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_sim_category 
											  WHERE fld_id='".$catid."' 
											  AND fld_delstatus='0'");
