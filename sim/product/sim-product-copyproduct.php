...
<section data-type='#sim-product-copyproduct' id='sim-product-copyproduct'>
	<div class='container'>
    	<div class='row'>
      		<div class='twelve columns'>
            	<p class="dialogTitle"><?php if($pid == 0){ echo "Define New Product";} else { echo "Copy ".$productname;} ?></p>
                ...
                <form method='post' name="validate" id="validate">
                    <div class="row">
						...
						<div class="six columns">
                            ...
                            <dl class='field row'>
                                <dt class='text'>
                                    <input id="vnumber" name="vnumber"  placeholder='Product Version Number' tabindex="1" type='text' value="">
                                </dt>
                            </dl> 
                        </div>
						<div class="row">
							<div class='six columns'>
								...
								<dl class='field row'>
									<dt class='text'>
										<input id="productcode" name="productcode"  placeholder='Product Code' tabindex="1" type='text' value="">
									</dt>
								</dl> 
							</div>
						</div>
