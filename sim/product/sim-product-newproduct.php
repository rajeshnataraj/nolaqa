<?php
	...
	else
	{
		...
		$productcode = $ObjDB->SelectSingleValue("SELECT fld_product_code FROM itc_sim_product WHERE fld_id='".$pid."' AND fld_delstatus='0'");
		$vernumber = $ObjDB->SelectSingleValue("SELECT fld_version_number FROM itc_sim_product WHERE fld_id='".$pid."' AND fld_delstatus='0'");
