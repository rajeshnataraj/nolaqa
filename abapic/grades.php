...
$qry = $ObjDB->QueryObject("SELECT fld_id AS subid, fld_sub_guid AS subguid 
			    FROM itc_correlation_doc_subject limit 0,".$split."");
if($qry->num_rows > 0)
{
...
$msg="Grades are inserted/updated in the corressponding tables on grades.php and the process has been completed successfully";
