<?php
	...
	$classid = $id[1]; 
		...
		$qrystep1 = $ObjDB->QueryObject("SELECT count(b.fld_id) as modulecount,a.fld_id as scheduleid,a.fld_schedule_name as schedulename,a.fld_moduletype as moduletype, a.fld_startdate as startdate,a.fld_numberofcopies as numberofcopies,a.fld_numberofrotations as numberofrotations,a.fld_rotationlength as rotationlength FROM itc_class_rotation_schedule_mastertemp as a left join itc_class_rotation_schedule_module_mappingtemp as b on b.fld_schedule_id=a.fld_id WHERE a.fld_class_id='".$classid."' AND b.fld_flag=1 AND a.fld_id='".$scheduleid."'");
		$row=$qrystep1->fetch_assoc();
		extract($row);
		
		if($moduletype==1)
		{
			$qrymodule=$ObjDB->NonQuery("SELECT a.fld_id as moduleid,CONCAT(a.fld_module_name,' ',b.fld_version) as modulename,1 as type
			           FROM itc_module_master AS a 
			           LEFT JOIN itc_module_version_track AS b ON b.fld_mod_id=a.fld_id 
			           LEFT JOIN itc_class_rotation_schedule_module_mappingtemp AS c ON c.fld_module_id=a.fld_id 
		...
		{
			$qrymodule=$ObjDB->NonQuery("SELECT a.fld_id as moduleid, CONCAT(a.fld_mathmodule_name,' ',b.fld_version) as modulename,2 as type 
			          FROM itc_mathmodule_master AS a 
					  LEFT JOIN itc_module_version_track AS b ON b.fld_mod_id=a.fld_module_id 
			          LEFT JOIN itc_class_rotation_schedule_module_mappingtemp AS c ON c.fld_module_id=a.fld_id 
					  WHERE c.fld_schedule_id='".$scheduleid."' AND c.fld_type='2' AND c.fld_flag=1 AND b.fld_delstatus='0' AND a.fld_delstatus='0' 
					  UNION ALL 
					  SELECT a.fld_id as moduleid,a.fld_contentname as modulename,8 as type 
					  FROM itc_customcontent_master as a 
					  LEFT JOIN itc_class_rotation_schedule_module_mappingtemp AS b ON b.fld_module_id=a.fld_id 
...
<section data-type='#class-newclass' id='class-newclass-viewschedule_create'>
                    	...
                    	<div class="row rowrotation"> <!-- Start and End Rotation textbox -->
                            ...
                            <div class="two columns">
                              ...
                              <div style="margin-left:30px;">
	                            ...
	                            <input type="checkbox" name="autoblock" id="autoblock"  onclick="fn_autoblock(<?php echo $scheduleid;?>);"/>
                              </div>
                            ...
                            <div class="six columns">
                                ...
                                &nbsp;&nbsp;<input type="button" style="cursor:pointer;width:120px;text-align:center;" id="addmodinc" class="addmodinc btn dim" value="Add Module" onclick="fn_showmodule(<?php echo $scheduleid;?>);" />
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="cursor:pointer;width:100px;height:50px;text-align:center;" id="save" onclick="fn_save();" class="save btn dim" value="Save"/>
                            </div>
...
<?php
	...
	$qryclassstudentmap=$ObjDB->QueryObject("SELECT a.fld_id, a.fld_fname, a.fld_lname FROM itc_user_master AS a LEFT JOIN itc_class_rotation_schedule_student_mappingtemp AS b ON a.fld_id=b.fld_student_id WHERE b.fld_schedule_id='".$scheduleid."' AND b.fld_flag=1 AND a.fld_activestatus='1' AND a.fld_delstatus='0' ");
...
$qrystudent=$ObjDB->QueryObject("SELECT fld_studentid AS stuid,fld_moduletype as type,fld_moduleid AS modid FROM itc_class_rotation_blockstudent WHERE fld_scheduleid='".$scheduleid."' AND fld_classid='".$classid."' AND fld_flag='1' ");
