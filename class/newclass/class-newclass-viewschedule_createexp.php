		...
		extract($row);
                ...
                $qryexp=$ObjDB->QueryObject("SELECT 
                                                    ...
                                                    fn_shortname(CONCAT(a.fld_exp_name, ' ', b.fld_version),
                                                            1) AS shortname,
                                                    CONCAT(a.fld_exp_name, ' ', b.fld_version) as expname,'17' As type
...
<section data-type='#class-newclass' id='class-newclass-viewschedule_createexp'>
                    	...
                    	<div class="row rowrotation"> <!-- Start and End Rotation textbox -->
                            ...
                            <div class="two columns">
                              ...
                              <div style="margin-left:30px;">
	                            ...
	                            <input type="checkbox" name="autoblock" id="autoblock"  onclick="fn_autoblockexp(<?php echo $scheduleid;?>);"/>
                              </div>
                            ...
                            <div class="six columns">
                            	<input type="button" class="btn" value="Generate" id="generatebtn" name="generate" onclick="fn_expgenerate();" />
                                ...
                                &nbsp;&nbsp;<input type="button" style="cursor:pointer;width:120px;text-align:center;" id="addmodinc" class="addmodinc btn dim" value="Add Exp" onclick="fn_showexpedition(<?php echo $scheduleid;?>);" />
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" style="cursor:pointer;width:100px;height:50px;text-align:center;" id="save" onclick="fn_saveexpdetails();" class="save btn dim" value="Save"/>
                            </div>
...
<?php
	...
	$qryclassstudentmap=$ObjDB->QueryObject("SELECT a.fld_id, a.fld_fname, a.fld_lname FROM itc_user_master AS a LEFT JOIN itc_class_rotation_expschedule_student_mappingtemp AS b ON a.fld_id=b.fld_student_id WHERE b.fld_schedule_id='".$scheduleid."' AND b.fld_flag=1 AND a.fld_activestatus='1' AND a.fld_delstatus='0' ");
...
$qrystudent=$ObjDB->QueryObject("SELECT fld_studentid AS stuid, fld_expeditionid AS expid FROM itc_class_rotation_expblockstudent WHERE fld_scheduleid='".$scheduleid."' AND fld_classid='".$classid."' AND fld_flag='1' ");
