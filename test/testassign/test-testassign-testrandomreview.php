...
?>
<section data-type='#test-testassign' id='test-testassign-testrandomreview'>
                                        ...
                                        echo "<br/><br/>";  
                                                ...
                                                if($qryqdetails->num_rows>0){
                                                    ...
                                                    while($rowqdetails = $qryqdetails->fetch_assoc()){
                                                        ...
                                                        ?>
                                                            <div class="wizardReportData" onclick="fn_showquestionrandominner(<?php echo $id[0];?>,<?php echo $qid;?>);" style="width:550px;cursor:pointer;"><?php echo  $j.".".trim(str_replace("&nbsp;", "",$tempqusname));?></div>
                                                        <?php
                                                        $j++;
                                                    }
