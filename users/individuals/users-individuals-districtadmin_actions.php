...
?>
<section data-type='#users-individuals' id='users-individuals-districtadmin_actions'>
  <div class='container'>
    <div class='row'>
    ...
    <div class='row buttons'>
      <a class='skip btn mainBtn' href='#users-individuals-districtadmin_newdistrictadmin' id='btnusers-individuals-districtadmin_newdistrictadmin' name='<?php echo $id[0];?>'>
        <div class="icon-synergy-edit"></div>
        <div class='onBtn'>Edit</div>
      </a>
      <a class='skip btn main' href='#users-individuals-districtadmin_newdistrictadmin' onclick="fn_deletdistrictadmin(<?php echo $id[0];?>)">
      ...
      <a class='skip btn main <?php if($status !=1){ echo "dim"; } ?>' href='#users-individuals-districtadmin_newdistrictadmin' onclick="fn_resetda(<?php echo $id[0];?>)">
