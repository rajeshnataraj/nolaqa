...
?>
<section data-type='#users-individuals' id='users-individuals-teacher_actions'>
	<div class='container'>
    	<div class='row'>
    	...
    	<div class='row buttons'>
     		<a class='skip btn mainBtn' href='#users-individuals-teacher_newteacher' id='btnusers-individuals-teacher_newteacher' name='<?php echo $id[0].",".$id[2].",".$id[3].",".$id[4];?>'>
        		<div class="icon-synergy-edit"></div>
        		<div class='onBtn'>Edit</div>
      		</a>
      		<a class='skip btn main' href='#users-individuals-teacher_newteacher' onclick="fn_deletteacher(<?php echo $id[0];?>)">
			...
			<?php $status = Table::SelectSingleValueInt("SELECT fld_activestatus FROM itc_user_master WHERE fld_id='".$id[0]."' AND fld_delstatus='0'");?>
      		<a class='skip btn main <?php if($status !=1){ echo "dim"; } ?>' href='#users-individuals-teacher_newteacher' onclick="fn_resett(<?php echo $id[0];?>)">
