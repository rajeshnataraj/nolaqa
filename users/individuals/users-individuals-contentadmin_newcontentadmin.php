...
$username='';
	...
	$qrytag = $ObjDB->QueryObject("SELECT a.fld_id AS tagid,a.fld_tag_name AS tagname 
									...
									WHERE a.fld_id=b.fld_tag_id AND b.fld_tag_type='12' AND b.fld_access='1' AND a.fld_created_by='".$uid."' AND a.fld_delstatus='0' 
...
<script type="text/javascript" charset="utf-8">	
	...
	$(function(){				
		var t4 = new $.TextboxList('#form_tags_newcontent', 
		{
...
<section data-type='users' id='users-individuals-contentadmin_newcontentadmin'>
	<div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle"><?php if($editid == 0){ echo "New Content Admin";} else { echo $fname." ".$lname." "."Content Admin";} ?></p>
        ...
        <div class='row formBase'>
            <div class='eleven columns centered insideForm'>
                <form method='post' name="cadmin" id="cadmin">
                    <div class="row">
                        <div class="six columns">
                            <div class="title-info">Content Admin Information (Required)</div>
                        ...
                        <div class="six columns">
                            <div class="title-info">Content Admin Additional Information (Optional)</div>
                            Street Address
                            <dl class='field row'>
                                <dt class='text'>
                                            ...
                                            <ul role="options">
                                                <?php 
                                                    $stateqry = $ObjDB->QueryObject("SELECT DISTINCT(fld_statevalue) AS statevalue, fld_statename AS statename 
																					FROM itc_state_city 
																					WHERE fld_delstatus=0 ORDER BY fld_statename ASC");
                    ...
                    <div class="row rowspacer"> 
                        <div class='twelve columns'>
                            ...
                            <div class="tag_well">
                                <input type="text" name="test3" value="" id="form_tags_newcontent" />
                            </div>
                        </div>
                    </div>
                    	...
                    	<?php 
                            ...
                            <div class="six columns <?php if($status !=1){ echo "dim"; } ?>">
                                <p class='btn secondary twelve columns'>
                                  <a tabindex="12" onclick="fn_resetca('<?php echo $username;?>')">Reset Password</a>
                                </p>
                            </div>
                         <?php }
                    ...
                    <div class="row rowspacer">
                        <div class="six columns">
                            <p class='btn primary twelve columns'>
                            	 <?php if($editid == 0){ ?>
                               		<a tabindex="14" onclick="fn_cancel('users-individuals-contentadmin');">Cancel</a>
                                 <?php } else { ?>
                                 	<a tabindex="14" onclick="fn_deletcontentadmin(<?php echo $editid;?>)">Delete</a>
                                 <?php } ?>   
                            </p>
                        </div>
                        <div class="six columns" id="userphoto">
                            <p class='btn secondary twelve columns'>
                                 <a tabindex="15" onclick="fn_createcontentadmin(<?php echo $editid;?>);"><?php if($editid==0) echo "Create Content Admin"; else echo "Update Content Admin";?></a>
                            </p>
                        </div>
                    </div>
                </form>
