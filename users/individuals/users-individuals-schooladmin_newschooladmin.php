<?php
	...
	$qrytag = $ObjDB->QueryObject("SELECT a.fld_id AS tagid,a.fld_tag_name AS tagname 
									...
									WHERE a.fld_id=b.fld_tag_id AND b.fld_tag_type='10' AND b.fld_access='1' AND a.fld_created_by='".$uid."' 
	...
	if($editid != 0){
		$shldistid = $id[1];
		if($shldistid == 0){
			$selectdet = $ObjDB->QueryObject("SELECT a.fld_username AS username, a.fld_email AS email,a.fld_fname AS fname,a.fld_lname AS lname,a.fld_district_id AS distid, 
												a.fld_school_id AS shlid,a.fld_profile_pic AS pphoto, d.fld_city AS city,d.fld_state AS state,
												c.fld_statename AS statename,d.fld_school_name AS shlname 
			...
			$selectdet = $ObjDB->QueryObject("SELECT a.fld_username AS username, a.fld_email AS email,a.fld_fname AS fname,a.fld_lname AS lname,a.fld_district_id AS distid,
												...
												b.fld_state AS state,c.fld_statename AS statename,d.fld_school_name AS shlname 
											FROM itc_user_master AS a,itc_district_master AS b,itc_state_city AS c,itc_school_master AS d 
											WHERE a.fld_id= '".$editid."' AND a.fld_district_id=b.fld_id AND a.fld_school_id=d.fld_id AND 
												b.fld_state=c.fld_statevalue AND a.fld_delstatus='0' AND c.fld_statename <>'' 
											GROUP BY a.fld_id");
		}
	...
	if($sessmasterprfid == 6){
		$selectdist = $ObjDB->QueryObject("SELECT fld_id as id, fld_district_name as distname, fld_state AS distsatate , fld_city AS distcity, 
											fld_zipcode AS distzip 
...
<section data-type='#users-individuals' id='users-individuals-schooladmin_newschooladmin'>
    <div class='container'>
        <div class='row'>
          <div class='twelve columns'>
          	<p class="dialogTitle"><?php if($editid == 0){ echo "New School Admin";} else { echo $fname." ".$lname." "."School Admin";} ?></p>
                ...
                <form method='post' name="dadminval" id="dadminval">
                    <div class="row">
                        <div class="six columns">
                            <div class="title-info">School Admin Information (Required)</div>
                                ...
                                <dt class='dropdown'>
                                   ...
                                   <?php } 
                                        ...
                                        <div class="selectbox">
                                            ...
                                            <input type="hidden" name="ddlstate" id="ddlstate" value="<?php echo $state;?>" onchange="$(this).valid();fn_changecity(this.value);">
                        ...
                        <div class="six columns">
                            <div class="title-info">School Admin Additional Information (Optional)</div>
                            Select state
                            <dl class='field row'>
                                <dt class='dropdown'>
                                    <div class="selectbox">
                    ...
                    <div class="row rowspacer">
                        ...
                        Street address
                            <dl class='field row'>
                                <dt class='text'>
                                    <input  id="address" name="address" placeholder='Street address' tabindex="10" type='text' value="<?php echo $arrcombine[7];?>">
                                </dt>
                            </dl>
                        </div>
                    </div>
                                            ...
                                            <ul role="options">
                                                <?php 
                                                    $shlqry = $ObjDB->QueryObject("SELECT fld_id, fld_school_name AS schoolname 
																					...
																					WHERE fld_district_id ='".$sendistid."' AND fld_delstatus='0' 
																					ORDER BY fld_school_name ASC ");
                                                    while($rowshl = $shlqry->fetch_assoc()){ 
													extract($rowshl);
													?>
                                                           <li><a href="#" data-option="<?php echo $fld_id;?>"><?php echo $schoolname;?></a></li>
                                                    <?php 
                                                    }?>       
                                            </ul>
                                          </div>
                    ...
                    <div class="row rowspacer">
                        ...
                        Office number 
                            <dl class='field row'>
                                <dt class='text'>
                                    <input id="officeno" name="officeno" placeholder='Office number' tabindex="12" type='text' value="<?php echo $arrcombine[3];?>">
                                </dt>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="row rowspacer">
                        ...
                        Fax number
                            <dl class='field row'>
                                <dt class='text'>
                                   <input id="faxno" name="faxno" placeholder='Fax number' tabindex="13" type='text' value="<?php echo $arrcombine[4];?>">
                                </dt>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="row rowspacer">
                        ...
                        Mobile number
                            <dl class='field row'>
                                <dt class='text'>
                                   <input id="mobileno" name="mobileno" placeholder='Mobile number' tabindex="14" type='text' value="<?php echo $arrcombine[5];?>">
                                </dt>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class='row rowspacer'>
                        <div class='twelve columns'>
                            ...
                            <div class="tag_well">
                                <input type="text" name="test3" tabindex="16" value="" id="form_tags_newschool" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row rowspacer">
                    	<?php 
                            ...
                            <div class="six columns <?php if($status !=1){ echo "dim"; } ?>">
                                <p class='btn secondary twelve columns'>
                                  <a tabindex="17" onclick="fn_resetsa('<?php echo $username;?>')">Reset Password</a>
                                </p>
                            </div>
                         <?php }
                        ...
                        <div class="six columns">
                            <p class='btn secondary twelve columns'>
                               <a tabindex="18" onclick="fn_resendmail(<?php echo $editid;?>);">Resend Invitation</a>
                            </p>
                        </div>
                        <?php }?>
                    </div>    
                    <div class="row rowspacer">
                        <div class="six columns">
                            <p class='btn primary twelve columns'>
                            	 <?php if($editid == 0){ ?>
                               		<a tabindex="19" onclick="fn_cancel('users-individuals-schooladmin');">Cancel</a>
                                 <?php } else { ?>
                                 	<a tabindex="20" onclick="fn_deletschooladmin(<?php echo $editid;?>)">Delete</a>
                                 <?php } ?>   
                            </p>
                        </div>
                        <div class="six columns" id="userphoto">
                            <p class='btn secondary twelve columns'>
                            	 <a tabindex="15" onclick="fn_createschooladmin(<?php echo $editid;?>);"><?php if($editid==0) echo "Create School Admin"; else echo "Update School Admin";?></a>
                            </p>
                        </div>
                    </div>
                </form>
                    ...
                    $(function(){
                        $("#dadminval").validate({
                            ...
                            messages: {
                                ...
                                ddlzip : { required: "Please select zipcode" }
