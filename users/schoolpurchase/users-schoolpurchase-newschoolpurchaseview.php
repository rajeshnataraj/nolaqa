<?php 
	...
	$qrydetails = $ObjDB->QueryObject("SELECT a.fld_email AS email, CONCAT(a.fld_fname,' ',a.fld_lname) AS name1, b.fld_hubid AS hubid  
									...
									WHERE a.fld_id=b.fld_school_admin_id AND b.`fld_id`='".$id[0]."' AND b.fld_district_id='0' 
...
?>
<script language="javascript"> $.getScript("users/schoolpurchase/users-schoolpurchase-newschoolpurchase.js"); </script>
<section data-type='#users-schoolpurchase' id='users-schoolpurchase-newschoolpurchaseview'>

	<div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">View the school purchase details</p>
               		...
               		<div class="wizardReportcols">
                        ...
                        <div class="wizardReportData"><?php
							 $qryslicdetails = $ObjDB->QueryObject("SELECT  DISTINCT(a.`fld_id`) AS licid, a.`fld_license_name` AS licname 
																	...
																	WHERE a.fld_id = b.fld_license_id AND b.fld_district_id='0' and b.fld_school_id='".$id[0]."' 
																		and fld_user_id='0' and a.fld_delstatus='0'"); 
							 ...
							 if($qryslicdetails->num_rows!=0){ 
								...
								?>
                                	<div class="wizardReportData" style="cursor:pointer;" onclick="fn_splicdet(<?php echo $licid;?>,'<?php echo $id[0];?>');"><?php echo $templicname;?></div>
                                <?php
								}
							 }
							 ?></div>
        ...
        <div id="splicdetails" style="display: none;" >
        </div>
    </div>
</section>
<?php
