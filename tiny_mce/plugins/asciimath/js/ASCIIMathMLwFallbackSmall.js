...
var mathfontfamily="Arial,Helvetica,sans-serif"; // change to "" to inherit (works in IE) 
...
//{input:"!=",  tag:"mo", output:"\u2260", tex:null, ttype:CONST},
{input:"!=",  tag:"mo", output:"\u2260", tex:"not=", ttype:CONST}, // change !=
{input:":=",  tag:"mo", output:":=",     tex:null, ttype:CONST},
...
/*{input:"dx",   tag:"mi", output:"dx", tex:null, ttype:CONST},
{input:"dy",   tag:"mi", output:"dy}", tex:null, ttype:CONST},
{input:"dz",   tag:"mi", output:"dz}", tex:null, ttype:CONST},
{input:"dt",   tag:"mi", output:"dt}", tex:null, ttype:CONST},*/
...
{input:"triangle", tag:"mo", output:"\u9651", tex:null, ttype:CONST},
{input:"parallel", tag:"mo", output:"\u2225", tex:null, ttype:CONST},
...
{input:"overrightarrow", tag:"mover", output:"\u21D2", tex:null, ttype:UNARY, acc:true},
{input:"overleftarrow", tag:"mover", output:"\u2190", tex:null, ttype:UNARY, acc:true},
{input:"overleftrightarrow", tag:"mover", output:"\u2194", tex:null, ttype:UNARY, acc:true},
...
function AMTparseMath(str) {
  ...
  var texstring = AMTparseAMtoTeX(str.replace(/\s/g,"@"));
  ...
  if (displaystyle) {
	  texstring = "\\large" + texstring;
  } else {
	  texstring = "\\textstyle" + texstring;
  }
  
  //alert(texstring);
  texstring = "\\png\\dpi{120}\\definecolor{blueblack}{RGB}{73,112,138}\\color{blueblack}\\boldsymbol{" + texstring +"}";
  texstring = texstring.replace('$','\\$');
  texstring = texstring.replace(/\\circ/g,'\\;');
