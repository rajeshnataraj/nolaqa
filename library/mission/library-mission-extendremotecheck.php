...
/*
	...
	Page - library-mission-extendremotecheck
	Description:
...
if($oper=="checkextendname" and $oper != " " ) {
    ...
    $count = $ObjDB->SelectSingleValueInt("SELECT COUNT(fld_id) FROM itc_mis_extendmaterials_master WHERE fld_extend_text='".$txtextensionname."' AND fld_delstatus='0' AND fld_created_by='".$uid."' AND fld_mis_id='".$expid."' AND fld_id<>'".$extid."'"); 
