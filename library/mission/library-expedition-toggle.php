                ...
                <form name="exporderforms" id="exporderforms">
                        ...
                        <table class='table table-striped table-bordered setbordertopradius' id="expordertable" width="100%">
                            <thead class='tableHeadText'>
                                <tr>
                                    <th class='centerText' style="width: 50%">Title</th>
                                    <th class='centerText' style="width: 25%">Type</th>
                        ...
                        for($i=0;$i<$destcnt;$i++)
                        {
                            ...
                            <tr>
                                ...
                                <td style="width: 25%" class='centerText'>
                                    Destination
                                </td>
                            	<td style="width: 25%" <?php if($desttoggle[$i]==1) {?>class='dim'<?php } ?>>
                            ...
                            for($j=0;$j<$taskcnt;$j++)
                            {
                                ...
                                <tr>
                                    ...
                                    <td style="width: 25%" <?php if($tasktoggle[$i]==1) {?>class='dim'<?php } ?>>
                                ...
                                for($k=0;$k<$rescnt;$k++)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 25%" class='centerText'>
                                            <div><?php if($restype[$k]==1) echo "Instructional "; else echo "Activity ";?>Resource</div>
                                        </td>
                                        <td style="width: 25%;" <?php if($restoggle[$k]==1) {?>class='dim'<?php } ?>>
