...
$qry_materiallist_det=$ObjDB->QueryObject("SELECT fld_materials AS materialname, fld_mat_desc AS materialdesc, fld_thumbimg_url AS thumbimgpath, fld_upload_path AS uploadimg
                                             FROM itc_materials_master WHERE fld_id='".$materialid."' AND fld_delstatus='0'"); // get the materil's details using materialid
...
?>
<section data-type='#library-materials' id='library-materials-viewmaterials'>
    <div class='container'>
        <div class='row'>
                  ...
                  <div class='row rowspacer' id="unitbtn">
                       <div class='row'>
                            <div class='four columns btn primary push_two noYes' style="margin-left:35%;">
                                <a onclick="fn_cancel('library-materials-actions')" tabindex="4">Close</a>
                            </div>
