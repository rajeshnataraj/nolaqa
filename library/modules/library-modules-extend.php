...
$.getScript('library/modules/library-extend.js');
...
<section data-type='2home' id='library-modules-extend'>
<div class='container'>
        <div class='row'>
            ...
            <div class='span10 offset1' id="licenselist">
                <table id="extendtable" class='table table-hover table-striped table-bordered setbordertopradius'>
                    <thead class='tableHeadText'>
                        <tr>
                            <th width="22%"><?php echo $modulename; ?></th>
