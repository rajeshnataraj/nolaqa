...
?>
<section data-type='2home' id='library-ipls'>
    <div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="darkTitle">IPLs</p>
        ...
        <div class='row'>
            <div class='twelve columns'>            	
                <p class="<?php if($sessmasterprfid == '10'){ echo "filterLightTitle"; }else { echo "filterDarkTitle"; } ?>">To view the list of IPLs within a Unit, click on a specific Unit.</p>
                <div class="tag_well">
              	</div>
            </div>
        </div>
