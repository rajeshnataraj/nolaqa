...
$rubricname=$ObjDB->SelectSingleValue("SELECT fld_rub_name FROM itc_exp_rubric_name_master WHERE fld_exp_id='".$expeditionid."' AND fld_id='".$rubricnameid."' ");//AND fld_created_by='".$uid."'
...
?>
<section data-type='#library-rubric' id='library-rubric-preview'>
...
<div class='container'>
    <div class='row'>
            ...
            <div id="dist" style="" class="row rowspacer">
                ...
                <input type="button" onClick="fn_downloadpdf(<?php echo $expeditionid; ?>,<?php echo $rubricnameid; ?>,'<?php echo $rubricname.'_'; ?>');" value="Download to Print / Save" style="height:42px; float:right;" id="btnstep" class="darkButton">
            </div>
    </div>
