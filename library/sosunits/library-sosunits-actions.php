...
?>
<section data-type='#library-sosunits' id='library-sosunits-actions'>
    <div class='container'>
        <div class='row'>
        ...
        <div class='row buttons rowspacer'>
            <a class='skip btn mainBtn' href='#library-sosunits' id='btnlibrary-sosunits-viewunits' name='<?php echo $id[0];?>'>
                <div class='icon-synergy-view'></div>
                <div class='onBtn'>View</div>
            </a>
            <?php if($sessprofileid == 2) { ?>
            <a class='skip btn mainBtn' href='#library-sosunits' id='btnlibrary-sosunits-newunits' name='<?php echo $id[0];?>'>
                <div class='icon-synergy-edit'></div>
                <div class='onBtn'>Edit</div>
            </a>
            <a class='skip btn main <?php if($count==0)echo 'dim'; ?>' href='#library-sosunits' onclick="fn_deleteunits(<?php echo $id[0];?>)">
