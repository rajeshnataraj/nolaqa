...
/*
	...
	Page - library-mathmodules-extend
	Description:
	   Basically  this option using for teacher to  guide the student with extra information while students studying mathmodules.
...
$modulename='';
$filename='';
$moduleqry=$ObjDB->QueryObject("SELECT a.fld_id AS mathid,a.fld_mathmodule_name AS modulename,b.fld_file_name AS filename  FROM itc_mathmodule_master AS a 
...
$.getScript('library/mathmodules/library-extend.js');
</script>
<section data-type='2home' id='library-mathmodules-extend'>
<div class='container'>
        <div class='row'>
            <div class='twelve columns'>
            	<p class="dialogTitle">Math Module</p>
                ...
                <table id="extendtable" class='table table-hover table-striped table-bordered'>
                    ...
                    <tbody>
					   ...
					   $qry=$ObjDB->QueryObject("SELECT fld_id,fld_extend_text,fld_created_name,fld_created_by,fld_module_id 
					                            FROM itc_extendtextmath_master 
					   ...
					   if($qry->num_rows>0)
					   {
						  ...
						  $exttendid=$rowmodulextend->fld_id;
						   ...
						   $extendmoduleid=$rowmodulextend->fld_module_id;
						   	$access=true;
                        ...
                        <tr class="Btn" id="module-extend-<?php echo $exttendid; ?>">
                            ...
                            <td class="createnewtd">
                               <div style="margin-left: 74px;" > 
                                ...
                                onclick="showfullscreenmoduleextend('<?php echo "0,".$moduleid.",".$mathid.",".$exttendid.",".$access.",".$uid;?>');">
