...
{
$ownrubricorothers=$ObjDB->SelectSingleValueInt("SELECT count(fld_id) FROM itc_mis_rubric_name_master WHERE fld_id='$rubricnameid' AND fld_mis_id='$missionid' AND fld_delstatus='0' AND fld_created_by='".$uid."'");
}
...
$exptitle=$ObjDB->SelectSingleValue("SELECT a.fld_mis_name FROM itc_mission_master AS a
  ...
  $rubricname=$ObjDB->SelectSingleValue("SELECT fld_rub_name FROM itc_mis_rubric_name_master WHERE fld_mis_id='".$missionid."' AND fld_delstatus = '0' AND fld_id='".$rubricnameid."'"); //new line  AND fld_created_by='".$uid."'
  
?>
<section data-type='#library-missionrubric' id='library-missionrubric-graderubric'>
    ...
    <div class='row formBase rowspacer'>
        <div class='eleven columns centered insideForm'>
            ...
            <div class='row  rowspacer'> 
                ...
                <div class='six columns'>
                  <input class="darkButton" type="button" id="btnstep2" style="width:200px; height:42px; float:right;  margin-top: 25px;" value="Add New Section" onClick="fn_addnewsection(<?php echo $missionid;?>,<?php echo $rubricnameid;?>,'0','','1','0');"  />
              </div>
             </div>
                ...
                <div class='rowspacer formBase'>  
                    <div id="expsetting" class='row rowspacer'>  
                        <div class='span10 offset1'>
                            <table class='table table-hover table-striped table-bordered setbordertopradius' id="mytableold" >
                                <thead >
						 ...
						 <div style="height:547px;overflow-y: auto;">
							  <table class='table table-hover table-striped table-bordered setbordertopradius' id="mytable" >
                                ...
                                $qrydest=$ObjDB->QueryObject("SELECT a.fld_id as destid,a.fld_dest_name as destname FROM itc_mis_rubric_dest_master as a
                                                                  ...
                                                                  WHERE a.fld_mis_id='".$missionid."' 
                                                                  AND a.fld_rubric_name_id='".$rubricnameid."'  AND a.fld_delstatus='0'");
                                      ...
                                      ?>
                                        ...
                                        <thead id="head_<?php echo $did[$i]; ?>">
                                          <tr class="bcolor">
                                              ...
                                              <td colspan="7" id="destnationtxt-<?php echo $did[$i];?>" style="font:  bold 14px/30px Times New Roman;" onclick="fn_addnewsection('<?php echo $missionid; ?>','<?php echo $rubricnameid; ?>','<?php echo $did[$i]; ?>','<?php echo $dname[$i];?>','0');">
                                                <?php echo $dname[$i];?>
                                              </td>
                                          </tr>
                                        </thead>
                                          ...
                                          <?php
                                            $qryviewexp_rubric=$ObjDB->QueryObject("SELECT c.fld_id as rowid, a.fld_id as destid,a.fld_dest_name as destname, c.fld_category as category,c.fld_four as four,c.fld_three as three,
                                                                                    c.fld_two as two,c.fld_one as one, c.fld_zer as zer ,c.fld_weight as weight,c.fld_score as score FROM itc_mis_rubric_dest_master as a
                                                                                        ...
                                                                                        WHERE c.fld_rubric_id='".$rubricnameid."' AND c.fld_mis_id='".$missionid."' 
                                            ...
                                            if($qryviewexp_rubric->num_rows > 0) 
                                            {
                                                ...
                                                while($row=$qryviewexp_rubric->fetch_assoc())
                                                {
                                                    ...
                                                    $rowval[]=$rowid;
                                                    ?>
                                                    <tr class="exp-rubric-<?php echo $did[$i]; ?>" id="exp-rubric-<?php echo $rowid; ?>" onclick="fn_showdeststmteditform('<?php echo ($missionid); ?>','<?php echo $did[$i]; ?>','<?php echo $rowid; ?>','1','<?php echo $rubricnameid; ?>','1','<?php echo $dname[$i];?>');this.disabled='disabled';"  >
                                            ...
                                            <tr value="<?php echo $mohan;  ?>" id="countrow-<?php echo $mohan;  ?>">
                                                <td colspan="8">
                                                    <span onclick="fn_showdeststmtform('<?php echo ($missionid); ?>','<?php echo $did[$i]; ?>','0','<?php echo $rubricnameid; ?>','<?php echo $mohan; ?>','<?php echo $dname[$i];?>');this.disabled='disabled';" > <span class="icon-synergy-add-dark small-icon" style="padding-top:10px;"></span>Add additional category to this Interval</span>
                                                </td>
                                            </tr>                                              
                                      </tbody>
                                      <?php   
                    ...
                    $countrubric1=array();
                    $countrubric=$ObjDB->QueryObject("SELECT fld_id as rubricrowid FROM itc_mis_rubric_master WHERE fld_rubric_id='".$rubricnameid."' AND fld_mis_id='".$missionid."' AND fld_delstatus='0'");
                    ...
                    $dbrowcount=$ObjDB->SelectSingleValueInt("SELECT count(fld_id) FROM itc_mis_rubric_master WHERE fld_rubric_id='".$rubricnameid."' AND fld_mis_id='".$missionid."' AND fld_delstatus='0'");
                    $destcount=$ObjDB->SelectSingleValueInt("SELECT count(fld_id) FROM itc_mis_rubric_dest_master WHERE fld_mis_id='".$missionid."' AND fld_rubric_name_id='".$rubricnameid."' AND fld_delstatus='0'");
                    ...
                    <div class='twelve columns'>
                        <div class='six columns'>
                            <input class="darkButton" type="button" id="btnstep2" style="width:200px; height:42px; float:left;  margin-top: 25px;  margin-left: -18px;" value="Add New Section" onClick="fn_addnewsection(<?php echo $missionid;?>,<?php echo $rubricnameid;?>,'0','','1','0');"  />
                        </div>
                        <div class='six columns'>
                ...
                <?php
                    if($ownrubricorothers == 1 ){?>
                            ...
                            <div class='three columns'>
                                <input class="darkButton" type="button" id="btnstep2" style="width:200px; height:42px; float:right;" value="Update" onClick="fn_saveasrubric(<?php echo $missionid;?>,<?php echo $rubricnameid;?>,'1');"  />
                            </div>
                            <div class='three columns'>
                            </div>                          
                            ...
                            <div class='three columns' style="float: right">
                                <input class="darkButton" type="button" id="btnstep2" style="width:200px; height:42px; float:right;" value="<?php echo $createbtn;?>" onClick="fn_saveasrubric(<?php echo $missionid;?>,<?php echo $rubricnameid;?>,'0');"  />
                            </div>
                        </div><?php
                    }
                    else {?>
