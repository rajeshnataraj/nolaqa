...
?>
<section data-type='#library-units' id='library-units-actions'>
    <div class='container'>
        <div class='row'>
        ...
        <div class='row buttons rowspacer'>
            <a class='skip btn mainBtn' href='#library-units' id='btnlibrary-units-viewunits' name='<?php echo $id[0];?>'>
                <div class='icon-synergy-view'></div>
                <div class='onBtn'>View</div>
            </a>
            <?php if($sessprofileid == 2 || $sessprofileid == 3) { ?>
            <a class='skip btn mainBtn' href='#library-units' id='btnlibrary-units-newunits' name='<?php echo $id[0];?>'>
                <div class='icon-synergy-edit'></div>
                <div class='onBtn'>Edit</div>
            </a>
            <a class='skip btn main <?php if($count!=0)echo 'dim'; ?>' href='#library-units' onclick="fn_deleteunits(<?php echo $id[0];?>)">
