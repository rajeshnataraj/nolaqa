<?php	
	...
	$string = file_get_contents("http://content.pitsco.info/modules/".$filename."/book.xml");	 // change path
	$doc = new DOMDocument();
	$doc->loadXML($string);
...
<script type="text/javascript" language="javascript">
	...
	function LoadPageData(pageid, cindex) {
		...
		newpage = pageid;
		audioelements = 0;
		FRE.flashObject.loadPageData("http://content.pitsco.info/modules/"+modname+"/pages/"+pageid+".xml",null,'POST'); // change path
	...
	FRE.onPageInit = function (evt) {
		...
		this.flashObject.setBaseUrl('<?php echo "http://content.pitsco.info/modules/".$filename."/media/"; ?>'); // change path
		...
		//this.flashObject.setDebug(true);
