...
$msg = $ObjDB->SelectSingleValue("SELECT CONCAT(a.fld_module_name,' ',b.fld_version) 
								  ...
								  WHERE a.fld_id='".$id."' AND b.fld_delstatus='0'  AND a.fld_module_type='7'");
?>
<script type="text/javascript" charset="utf-8">	
	$.getScript('library/quests/library-quests.js');
</script>
<section data-type='#library-quests' id='library-quests-grade'>
    <div class='container'>
        <div class='row'>
                ...
                <form name="moduleforms" id="moduleforms">
					...
					if($sessmasterprfid!=2 and $sessmasterprfid!=3)
					{
						$qry = $ObjDB->QueryObject("SELECT fld_id, fld_page_title AS title, fld_preassment_id AS pageid, fld_grade AS grade, fld_points AS points, 
													...
													WHERE fld_module_id='".$id."' AND fld_flag='1' AND fld_school_id='".$schoolid."' AND fld_user_id='".$indid."' AND fld_schedule_type='7' 
					...
					if($qry->num_rows<=0 or $sessmasterprfid==2 or $sessmasterprfid==3)
                    {
						...
						$qry = $ObjDB->QueryObject("SELECT fld_id, fld_page_title AS title, fld_preassment_id AS pageid, fld_grade AS grade, fld_points AS points, 
														fld_session_id AS sessionid 
													FROM itc_module_wca_grade 
													WHERE fld_module_id='".$id."' AND fld_flag='1' AND fld_school_id='0' AND fld_user_id='0' AND fld_schedule_type='7' 
					...
					if($qry->num_rows<=0)
                    {
						$qry = $ObjDB->QueryObject("SELECT fld_id, fld_page_title AS title, fld_page_id AS pageid, fld_grade AS grade, fld_points AS points, fld_section_id AS sessionid 
												  ...
												  WHERE fld_module_id='".$id."' AND fld_flag='1'		
													UNION ALL 		
												  ...
												  WHERE fld_module_id='".$id."' AND fld_performance_name<>'Total Pages' AND fld_delstatus='0' 
