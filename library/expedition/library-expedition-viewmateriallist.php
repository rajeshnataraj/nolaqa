 ...
 * DB:itc_exp_extendmaterials_mapping
 */
...
?>
<section data-type='2home' id='library-expedition-viewmateriallist'>
    <div class='container'>
        <div class='row'>
            ...
            <table class='table table-striped table-bordered' id="mytable">
                ...
                <tbody> 
                  <?php
                   $qryviewexp_materials=$ObjDB->QueryObject("SELECT S2.fld_dest_name as destname,S3.fld_task_name as taskname,S4.fld_materials as materialname,S1.fld_id as expextendmaterials,S1.fld_created_by as userid
                                                              ...
                                                              INNER JOIN itc_materials_master AS S4 ON S4.fld_id = S1.fld_material where S1.fld_extend_id = '".$extendid."' AND S1.fld_created_by='".$uid."' AND S1.fld_delstatus='0' AND S4.fld_delstatus='0'
                                                              ");
                ...
                <?php     }      ?>
					...
					$qrymaterial = $ObjDB->QueryObject("SELECT fld_id AS destid, fld_dest_name AS destname, fn_shortname (CONCAT(fld_dest_name), 1) AS shortname, 
															...
															WHERE fld_exp_id='".$expid."' AND fld_flag='1' AND fld_delstatus='0'");
				}
				else{				
					if($sessmasterprfid==6){ //For District Admin
						$qrymaterial = $ObjDB->QueryObject("SELECT a.fld_id AS destid, a.fld_dest_name AS destname, fn_shortname (CONCAT(a.fld_dest_name), 1) AS shortname, 
																...
																WHERE a.fld_exp_id='".$expid."' AND b.fld_exp_id='".$expid."' AND a.fld_flag='1' AND b.fld_flag='1' 
                     ...
                     <tr>
                         <?php $chkuserextend= $ObjDB->SelectSingleValueInt("SELECT count(fld_id) FROM itc_exp_extendmaterials_master WHERE fld_id='".$extendid."' AND fld_created_by='".$uid."'");?>
