...
{	
    ...
    if(exptype =='1'){
        ...
        $('body').append('<div id="expedition-fullscreecn-header" title="Synergy ITC"><div id="divlbcontent" style="background:#FFFFFF;"><iframe src="'+ CONTENT_EXP_URL +'/emaps-masterclassic/index.php?expid='+expid+'&uid='+uid+'&height='+heigh+'&width='+weigh+'&hostname='+location.host+'" width="100%"></iframe></div></div>');
    }
    else{
        $('body').append('<div id="expedition-fullscreecn-header" title="Synergy ITC"><div id="divlbcontent" style="background:#FFFFFF;"><iframe src="' + CONTENT_EXP_URL +'/emaps-master/index.php?expid='+expid+'&uid='+uid+'&height='+heigh+'&width='+weigh+'&hostname='+location.host+'" width="100%"></iframe></div></div>');
    }
